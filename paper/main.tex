...
Table~\ref{tab:capex} repeats the design for the capex ratio; an event-study figure
estimated from equation~\eqref{eq:es} will accompany it, plotting the quarterly
coefficients for both outcomes.
